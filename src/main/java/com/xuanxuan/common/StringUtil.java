...
public class StringUtil {
	...
	public static String RandomSex() {
		String[] sexs = {"男","女"};
		String sex = sexs[RandomUtil.random(0, sexs.length-1)];
		return sex;
	}
	
	//随机生成 邮箱
	public static String RandomEmail() {
		String[]  lastnames= {"@qq.com"," @163.com","@sian.com","@gmail.com","@sohu.com","@hotmail.com","@foxmail.com"};
		String lastname = lastnames[RandomUtil.random(0, lastnames.length-1)];
		String firname = RandomUtil.randomCharacter(RandomUtil.random(3, 20));
		return firname+ lastname;
	}
}
